var htmx = (function () {
	...
	function ht(e, t) {
		...
		if (e.type === 'submit' || e.type === 'click') {
			...
			if (
				...
				n.href &&
				(n.getAttribute('href') === '#' || n.getAttribute('href').indexOf('#') !== 0)
			) {
				return true;
			}
		}
	...
	function pn(e) {
		return (
			re(e, 'hx-encoding') === 'multipart/form-data' || (h(e, 'form') && ee(e, 'enctype') === 'multipart/form-data')
		);
	}
	function mn(t, n, r) {
		let o = null;
	...
	function Dn(o, i) {
		...
		if (f) {
			fe(
				o,
				'htmx:responseError',
				ce({ error: 'Response Status Error Code ' + s.status + ' from ' + i.pathInfo.requestPath }, i),
			);
		}
	}
	const Mn = {};
